          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="mt-3 text-gray-500">
                Answer 10 quick questions and get a personalized overview of
                your insulin sensitivity. Free, no sign-up required.
              </p>
            </div>
            <TallyQuizEmbed
              formId={
                process.env.NEXT_PUBLIC_TALLY_FORM_ID ?? "TALLY_FORM_ID"
              }
            />
          </div>
        </section>
